...
public class MyListener {
    ...
    {
        private HashMap<Interval, String> myStatement = new HashMap<>();
        ...
        public void enterAlterTable(sqliteParser.AlterTableContext ctx)
        {
           ...
           // if(ctx.DOT() != null)
             //   myStatement.put(ctx.DOT().getSourceInterval(),ctx.DOT().toString());
        ...
        /* @Override
        public void enterStringLiteral(sqliteParser.StringLiteralContext ctx)
        {
            myStatement.put(ctx.STRING_LITERAL().getSourceInterval(),ctx.STRING_LITERAL().toString());
          //  System.out.println(myStatement);
        }

        @Override
        public void enterIdentifier(sqliteParser.IdentifierContext ctx)
        {
            myStatement.put(ctx.IDENTIFIER().getSourceInterval(),ctx.IDENTIFIER().toString());
           // System.out.println(myStatement);
        }

        @Override
        public void enterKeyWordL(sqliteParser.KeyWordLContext ctx)
        {
            myStatement.put(ctx.keyword().getSourceInterval(),ctx.keyword().getText());
        }
*/
        ...
        public void enterSignedNumber(sqliteParser.SignedNumberContext ctx)
        {
         ...
         //   System.out.println(myStatement + "eem");
        }
        ...
        public void enterReferences (sqliteParser.ReferencesContext ctx)
        {
            ...
            //if(ctx.OPEN_PAR() != null)
              //  myStatement.put(ctx.OPEN_PAR().getSourceInterval(),ctx.OPEN_PAR().toString());
            //if(ctx.CLOSE_PAR() != null)
             //   myStatement.put(ctx.CLOSE_PAR().getSourceInterval(),ctx.CLOSE_PAR().toString());
            //if(ctx.COMMA(0) != null)
              //  myStatement.put( ctx.COMMA(0).getSourceInterval,ctx.COMMA().toString());
        ...
        public void enterCommonTableExpression (sqliteParser.CommonTableExpressionContext ctx)
        {
            if(ctx.K_AS() != null)
                myKeywords.put(ctx.K_AS().getSourceInterval(),ctx.K_AS().toString());
           /* if(ctx.OPEN_PAR() != null)
                myStatement.put(ctx.OPEN_PAR(0).getSourceInterval(),ctx.OPEN_PAR().toString());
            if (ctx.CLOSE_PAR()  != null)
                myStatement.put(ctx.CLOSE_PAR(0).getSourceInterval(),ctx.CLOSE_PAR().toString());
            if(ctx.COMMA() != null)
                myStatement.put(ctx.COMMA(0).getSourceInterval(),ctx.COMMA().toString());*/
        }
        ...
        public void enterDotANDstar(sqliteParser.DotANDstarContext ctx)
        {
            myColumnNames.put(ctx.STAR().getSourceInterval(),ctx.STAR().toString());
            //myColumnNames.put(ctx.DOT().getSourceInterval(),ctx.DOT().toString());
        }
        ...
        public void enterLiteralValue(sqliteParser.LiteralValueContext ctx)
        {
            if(ctx.NUMERIC_LITERAL() != null)
                myStatement.put(ctx.NUMERIC_LITERAL().getSourceInterval(),ctx.NUMERIC_LITERAL().toString());
            else if(ctx.STRING_LITERAL() != null)
                myStatement.put(ctx.STRING_LITERAL().getSourceInterval(),ctx.STRING_LITERAL().toString());
            else if(ctx.BLOB_LITERAL() != null)
                myStatement.put(ctx.BLOB_LITERAL().getSourceInterval(),ctx.BLOB_LITERAL().toString());
            else if(ctx.K_NULL() != null)
                myStatement.put(ctx.K_NULL().getSourceInterval(),ctx.K_NULL().toString());
            else if(ctx.K_CURRENT_TIME() != null)
                myStatement.put(ctx.K_CURRENT_TIME().getSourceInterval(),ctx.K_CURRENT_TIME().toString());
            else if(ctx.K_CURRENT_DATE() != null)
                myStatement.put(ctx.K_CURRENT_DATE().getSourceInterval(),ctx.K_CURRENT_DATE().toString());
            else
                myStatement.put(ctx.K_CURRENT_TIMESTAMP().getSourceInterval(),ctx.K_CURRENT_TIMESTAMP().toString());

           // System.out.println("hello again " +  myStatement);
        }
        ...
        public void enterUnaryOperator(sqliteParser.UnaryOperatorContext ctx)
        {
           ...
           // System.out.println(myStatement + "hello babe");
        }
        ...
        public void enterMyExpression(sqliteParser.MyExpressionContext ctx)
        {
           /* if(ctx.OPEN_PAR() != null)
            ...
            if(ctx.COMMA(0) != null)
                myStatement.put(ctx.COMMA(0).getSourceInterval(),ctx.COMMA().toString());
            if(ctx.DOT(0) != null)
                myStatement.put(ctx.DOT(0).getSourceInterval(),ctx.DOT().toString());*/
            if(ctx.PIPE2() != null)
            ...
            if(ctx.ASSIGN() != null)
                myKeywords.put(ctx.ASSIGN().getSourceInterval(),ctx.ASSIGN().toString());
            if(ctx.EQ() != null)
          ...
          /*  if(ctx.K_DISTINCT() != null)
           ...
           // System.out.println("please na ise sosto ! j meta sazw se apla gia na dulepsi lio :" + myStatement);
        ...
        {
           // if(ctx.COMMA() != null)
             //   myStatement.put(ctx.COMMA().getSourceInterval(),ctx.COMMA().toString());
           // else
            //{
        ...
        public void enterWithClause (sqliteParser.WithClauseContext ctx)
        {
           ...
           /* if(ctx.OPEN_PAR(0) != null)
                myStatement.put(ctx.OPEN_PAR(0).getSourceInterval(),ctx.OPEN_PAR().toString());
            if(ctx.CLOSE_PAR(0) != null)
                myStatement.put(ctx.CLOSE_PAR(0).getSourceInterval(),ctx.CLOSE_PAR().toString());
            if(ctx.COMMA() != null)
                myStatement.put(ctx.COMMA(0).getSourceInterval(),ctx.COMMA().toString());*/
        }

        /*public void enterCteTableName(sqliteParser.CteTableNameContext ctx)
        {
            if(ctx.OPEN_PAR() != null)
                myStatement.put(ctx.OPEN_PAR().getSourceInterval(),ctx.OPEN_PAR().toString());
            if(ctx.CLOSE_PAR() != null)
       ...
       /* public void enterQualifiedTableName(sqliteParser.QualifiedTableNameContext ctx)
        {
            if(ctx.DOT() != null)
            myStatement.put(ctx.DOT().getSourceInterval(),ctx.DOT().toString());
        }*/
        ...
        {
           /* if(ctx.COMMA(0) != null)
                myKeywords.put(ctx.COMMA(0).getSourceInterval(),ctx.COMMA().toString());*/
            if(ctx.K_ORDER() != null)
                myKeywords.put(ctx.K_ORDER().getSourceInterval(),ctx.K_ORDER().toString());
            if(ctx.K_BY() != null)
                myKeywords.put(ctx.K_BY().getSourceInterval(),ctx.K_BY().toString());
        ...
        public void enterUpdateStatement(sqliteParser.UpdateStatementContext ctx) {
            ...
            if(ctx.ASSIGN(0) != null)
                myKeywords.put(ctx.ASSIGN(0).getSourceInterval(),ctx.ASSIGN().toString());
        }
